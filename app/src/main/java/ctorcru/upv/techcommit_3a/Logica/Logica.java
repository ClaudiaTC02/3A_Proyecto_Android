                    ...
                    public void callback(int codigo, String cuerpo) {
                        ...
                        if(codigo == 200 && !cuerpo.isEmpty()){
                            ...
                            for(int i = 0; i < textoeparado.length; i++){
                                //en esta posición está almacenado el id
                                if(i==2){
                                    //nos guardamos el id
                                ...
                                //en esta posición está almacenado el nombre
                                if(i==3){
                                    //nos guardamos el nombre
                                    String correct= textoeparado[i].split(",")[0];
                                    String end1= correct.substring(1,correct.length()-1);
                                    //lo anyadimos a la variable encargada de almacenar el resultado
                                    res=res+end1+";";
                                }
                                //en esta posición está almacenado el correo
                                if(i==4){
                                    //nos guardamos el correo
                                    String correct= textoeparado[i].split(",")[0];
                                    String end1= correct.substring(1,correct.length()-1);
                                    //lo anyadimos a la variable encargada de almacenar el resultado
                                    res=res+end1+";";
                                ...
                                //en esta posición está almacenado la contrasenya
                                if(i==5){
                                    Log.d (ETIQUETA_LOG,"correaso " + res);
                                    //nos guardamos la contrasenya
                                    String correct= textoeparado[i].split(",")[0];
                                    String end1= correct.substring(1,correct.length()-1);
                                    //lo anyadimos a la variable encargada de almacenar el resultado
                                    res=res+end1+";";
                                }
                                //en esta posición está almacenado la foto
                               /* if(i==7){
                                    //nos guardamos la foto
                                    String correct= textoeparado[i].split(",")[0];
                                    String end1= correct.substring(1,correct.length()-1);
                                    //lo anyadimos a la variable encargada de almacenar el resultado
                                    res=res+end1+";";
